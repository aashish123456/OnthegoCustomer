...
@synthesize locationMngr, myLocation1,isAlreadyUpdatingLocation;
...
-(id)init{
    ...
    if(self){
        ...
        self.locationMngr.distanceFilter = kCLDistanceFilterNone;
        self.myLocation1 = CLLocationCoordinate2DMake(0, 0);
...
-(void)locationManager:(CLLocationManager *)manager didUpdateLocations:(NSArray *)locations{
    if(manager.location.coordinate.latitude == self.myLocation1.latitude && manager.location.coordinate.longitude == self.myLocation1.longitude){
        return;
    }
    NSLog(@":::::::::location did update::::::::::::");
    self.myLocation1 = manager.location.coordinate;
...
//   
//    [params setObject:@"client" forKey:@"Type"];
//    [params setObject:[SharedStorage getUserId] forKey:@"id"];
...
//    NSLog(@"%@",parameterNew);
//    
//    [PCServerCommunicator GetDataForMethod:@"InsertUpdateLatLong" withParameters:parameterNew onCompletion:^(BOOL status, NSError *error, NSDictionary *responseData)
//     {
//         
//         if(status == YES){
